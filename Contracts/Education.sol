...
contract Education {
    ...
    mapping(address => bool) public entitiesEducation; //Mapping of entities and their existence credibility based on education
    ...
    //Add a new entity to the education credibility contract. So far only the creator can add new checks.
